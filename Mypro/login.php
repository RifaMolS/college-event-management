...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            background-image: url('https://img.freepik.com/free-vector/abstract-blue-background_78370-60.jpg?t=st=1730373536~exp=1730377136~hmac=ef900bf3f5a9f11c4af504470910344ce4185421842db91964d34ac55d50a114&w=1060');
...
<body>
    <div class="container mt-5">
        ...
        <form action="login.php" method="post"  autocomplete="off">
            ...
            Don't have an account? <a href="user_reg.php">Create an Account Here -> Student</a><br><br>
            Don't have an account? <a href="eventcord_reg.php">Create an Account Here -> Event Coordinator</a>
        </form>
    </div>
</body>
</html>
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        switch ($row['type']) {
            ...
            case 'user':
                ...
                break;
            case 'event':
                echo "<script>location.href='eventcordinator_home.php'</script>";
                break;
            default:
                echo "<script>location.href=''</script>";
        }
